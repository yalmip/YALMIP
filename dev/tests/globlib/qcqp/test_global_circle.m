...
% Solve problem
sol = optimize(F,objvar,sdpsettings('bmibnb.uppersolver','fmincon','solver','bmibnb','bmibnb.absgaptol',1e-3,'bmibnb.relgaptol',1e-3))
testCase.assertTrue(sol.problem==0)
testCase.assertTrue(abs(value(objvar)-4.5742) <= 1e-2)