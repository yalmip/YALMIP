...
assert(abs(double(OO) - (-27.6)) <= 1e-5);
...
assert(abs(double(OO) -(-26.7900)) <= 1e-5);
...
assert(abs(double(OO) -( -256.2667)) <= 1e-4);
...
assert(abs(double(OO+exp(x1)+exp(x2)) -(-22.5404)) <= 1e-3);
...
assert(abs(double(OO-OO^2) -(-702)) <= 1e-5);
...
assert(abs(double(OO+OO^2) - (-.25)) <= 1e-5);
