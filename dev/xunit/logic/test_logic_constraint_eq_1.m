...
assert(double(a)==0 && (double(b)==0 || double(x)>=5));
...
assert(double(a)==1 && (double(b)==1 || double(x)==0));
...
assert(double(sum(sum(a-b)))==-4);

optimize([b(1)==1, true(and(a,b))],sum(sum(a-b)))
assert(double(sum(sum(a-b)))==0);

optimize([b(1)==1, true(xor(a,b))],sum(sum(-a-b)))
assert(double(sum(sum(-a-b)))==-6);
