...
assert(norm(double(x) - [1.89084694511033   4.32311245145436]') <= 1e-6)
assert(norm(double([inp1 inp2 inp3 inp4]) - [0 0 0 1]) <= 1e-6)
...
assert(sol.problem == 0);
assert(min(double([ii jj])) == [5]);
assert(max(double([ii jj])) == [7]);
